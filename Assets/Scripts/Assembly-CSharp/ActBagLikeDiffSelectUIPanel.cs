...
public class ActBagLikeDiffSelectUIPanel : MediatorCtrlBase, IUITableViewDataSource, IUITableViewDelegate, IUITableViewMargin
{
	...
	public ActBagLikeDiffSelectItemCell itemCell;

	private List<ActBagLikeDiffItemData> dataList;
