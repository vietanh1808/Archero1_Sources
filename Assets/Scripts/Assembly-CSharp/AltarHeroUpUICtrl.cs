...
public class AltarHeroUpUICtrl : MediatorCtrlBase, IUIGridViewDataSource, IUITableViewDataSource, IUITableViewDelegate
{
	...
	public AltarHeroChooseWindow heroWindow;

	private Dictionary<int, int> heroDict;

	[SerializeField]
	private UITableView tableView;

	[SerializeField]
	private AltarHeroItem cellItem;
	...
	private int GetHeroListIndex(int eid)
	{
		return 0;
	}
	...
	private List<uint> HeroDict_List()
	{
		return null;
	}
}
