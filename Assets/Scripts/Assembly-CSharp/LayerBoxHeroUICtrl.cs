...
public class LayerBoxHeroUICtrl : MediatorCtrlBase
{
	...
	public ScrollIntLayerBoxHeroCtrl mScrollInt;
	...
	private List<Box_ChapterHeroBox> mDataList;

	private LayerBoxHeroOneCtrl mChoose;
	...
	private void UpdateOne(int index, LayerBoxHeroOneCtrl one)
	{
	}

	private void UpdateSize(int index, LayerBoxHeroOneCtrl one)
	{
	}

	private void OnScrollEnd(int index, LayerBoxHeroOneCtrl one)
	{
	}
