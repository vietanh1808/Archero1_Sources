...
public class FishingTaskUIPanel : MonoBehaviour, IUILifeCycle, IUITableViewDataSource, IUITableViewDelegate, IUITableViewMargin
{
	[SerializeField]
	private FishingTaskItem taskItem;
