...
public class GameModeCooperation : GameModeBase
{
	private IDailyLevelsManager _dailyData;

	public override IStageLayerManager StageChapterMgr => null;

	public GameModeCooperation(IDailyLevelsManager dailyData)
	{
	}
	...
	private bool isQualifiedSkinId(int _skinId)
	{
		return false;
	}
