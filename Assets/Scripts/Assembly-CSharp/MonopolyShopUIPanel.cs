...
public class MonopolyShopUIPanel : MediatorCtrlBase, IUIGridViewDataSource, IUITableViewDataSource, IUITableViewDelegate
{
	...
	[SerializeField]
	private MonopolyShopItemCell cellItem;

	private List<MonopolyShopItemData> dataList;
