...
public class ConsumeDiamondMgr : SingletonNet<ConsumeDiamondMgr, STReqActivityCostDiamond, STRespActivityCostDiamond>
{
	...
	protected override STReqActivityCostDiamond RequestPacket()
	{
		return null;
	}
	...
	protected override void Response(NetResponse response, STRespActivityCostDiamond data, TimeRequest timeRequest = TimeRequest.None)
	{
	}
	...
	private static bool ValidateResponse(NetResponse response, out STRespActivityCostDiamond data, int id)
	{
		data = null;
		return false;
	}
