...
public class ArtifactAppraisaShopUIPanel : MediatorCtrlBase, IUIGridViewDataSource, IUITableViewDataSource, IUITableViewDelegate
{
	...
	[SerializeField]
	private ArtifactAppraisaShopItem cellItem;

	private List<ArtifactAppraisaShopItemData> dataList;
