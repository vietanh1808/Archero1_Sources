...
public class Weapon5301 : WeaponBase
{
	...
	private Tween mDelayedAttackTween;

	private Tween mFallbackClearTween;
	...
	private Transform createBullet5301(BulletBase b, Quaternion rotation, Vector3 startPos, Vector3 endPos)
	{
		return null;
	}
