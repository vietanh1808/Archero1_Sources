...
public class ManorEffectShowUI : MonoBehaviour, IUITableViewDataSource, IUITableViewDelegate, IUITableViewMargin
{
	public UITableView tableView;

	public ManorTitleCell titleItem;

	public ManorTextCell textItem;

	public ManorTimeCell timeItem;

	private List<ManorTextData> dataList;
	...
	public void init(List<ManorTextData> list)
	{
	}
