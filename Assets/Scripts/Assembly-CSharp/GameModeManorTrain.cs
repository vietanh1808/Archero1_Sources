...
public class GameModeManorTrain : GameModeBase
{
	public override IStageLayerManager StageChapterMgr => null;

	public override void AddDmgCount(EntityBase form, EntityBase target, long gotdmg)
	{
	}

	public override ulong GetDmgCount(EntityBase whomake)
	{
		return 0uL;
	}

	public override void RestDmgCount()
	{
	}

	public override bool NeedRemoveAfterRandom()
	{
		return false;
	}
