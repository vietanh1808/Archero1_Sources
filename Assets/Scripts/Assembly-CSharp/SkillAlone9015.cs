...
public class SkillAlone9015 : SkillAloneBase
{
	[CompilerGenerated]
	private sealed class _003CDelayCall_003Ed__10 : IEnumerator<object>, IEnumerator, IDisposable
	{
		...
		public SkillAlone9015 _003C_003E4__this;
	...
	private float buffCDTime;

	private float tribleRatio;

	private float preHitEnermyTime;
	...
	private void TriggerRay(EntityBase enermy)
	{
	}
}
