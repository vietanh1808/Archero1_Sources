...
public class CleverOnceTab : MonoBehaviour
{
	...
	private CleverOnceItemItemData[] pushData;
	...
	private static DelegateBridge __Hotfix0_get_unlockLevel;

	private static DelegateBridge __Hotfix0_get_CurItemData;
	...
	private CleverOnceItemItemData CurItemData => null;
	...
	private void purchaseSuccess(CRespInAppPurchase resp, bool success, CleverOnceItemItemData CurItemData)
	{
	}
