...
{
	public class CampPreRewardUIPanelWrap
	{
		...
		[MonoPInvokeCallback(typeof(lua_CSFunction))]
		private static int _g_get_Text_SubTitle(IntPtr L)
		{
			return 0;
		}

		[MonoPInvokeCallback(typeof(lua_CSFunction))]
		private static int _g_get_RT_Content(IntPtr L)
		{
			return 0;
		}
		...
		[MonoPInvokeCallback(typeof(lua_CSFunction))]
		private static int _s_set_Text_SubTitle(IntPtr L)
		{
			return 0;
		}

		[MonoPInvokeCallback(typeof(lua_CSFunction))]
		private static int _s_set_RT_Content(IntPtr L)
		{
			return 0;
		}
