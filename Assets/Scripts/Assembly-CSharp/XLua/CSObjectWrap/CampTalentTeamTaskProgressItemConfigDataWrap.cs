...
{
	public class CampTalentTeamTaskProgressItemConfigDataWrap
	{
		...
		[MonoPInvokeCallback(typeof(lua_CSFunction))]
		private static int _g_get_curNeedScore(IntPtr L)
		{
			return 0;
		}
		...
		[MonoPInvokeCallback(typeof(lua_CSFunction))]
		private static int _s_set_curNeedScore(IntPtr L)
		{
			return 0;
		}
