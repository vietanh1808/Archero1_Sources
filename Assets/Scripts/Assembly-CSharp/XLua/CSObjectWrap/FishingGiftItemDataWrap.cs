...
{
	public class FishingGiftItemDataWrap
	{
		...
		[MonoPInvokeCallback(typeof(lua_CSFunction))]
		private static int _g_get_ProductID(IntPtr L)
		{
			return 0;
		}

		[MonoPInvokeCallback(typeof(lua_CSFunction))]
		private static int _g_get_IsAdvertising(IntPtr L)
		{
			return 0;
		}
		...
		[MonoPInvokeCallback(typeof(lua_CSFunction))]
		private static int _g_get_IsDailyReset(IntPtr L)
		{
			return 0;
		}

		[MonoPInvokeCallback(typeof(lua_CSFunction))]
		private static int _g_get_Rewards(IntPtr L)
		{
			return 0;
		}
	}
