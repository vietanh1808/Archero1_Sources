...
{
	public class ActBossPlayRewardPreviewUIPanelWrap
	{
		...
		[MonoPInvokeCallback(typeof(lua_CSFunction))]
		private static int _g_get_tabs(IntPtr L)
		{
			return 0;
		}

		[MonoPInvokeCallback(typeof(lua_CSFunction))]
		private static int _g_get_itemObj(IntPtr L)
		{
			return 0;
		}
		...
		[MonoPInvokeCallback(typeof(lua_CSFunction))]
		private static int _s_set_tabs(IntPtr L)
		{
			return 0;
		}

		[MonoPInvokeCallback(typeof(lua_CSFunction))]
		private static int _s_set_itemObj(IntPtr L)
		{
			return 0;
		}
