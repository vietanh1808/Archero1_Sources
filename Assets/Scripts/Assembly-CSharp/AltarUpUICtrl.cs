...
public class AltarUpUICtrl : MediatorCtrlBase, IUIGridViewDataSource, IUITableViewDataSource, IUITableViewDelegate
{
	...
	[SerializeField]
	private AltarEquipItem cellItem;
	...
	private void chooseOne(ulong rowid)
	{
	}
	...
	private int getIndexByRowId(ulong rowid)
	{
		return 0;
	}
