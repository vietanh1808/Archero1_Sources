...
public class SkillAlone1127 : SkillAloneBase
{
	...
	private bool GetPortalPos(out Vector2Int pos_1, out Vector2Int pos_2)
	{
		pos_1 = default;
		pos_2 = default;
		return false;
	...
	private void ChangeCallPortalRate(int delta)
	{
	}
