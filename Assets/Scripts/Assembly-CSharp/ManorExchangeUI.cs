...
public class ManorExchangeUI : MonoBehaviour, IUIGridViewDataSource, IUITableViewDataSource, IUITableViewDelegate
{
	public DxxText Text_Title;

	public DxxText Text_Desc;

	public DxxText Text_BottomDesc;
	...
	[SerializeField]
	private ManorExchItemCell cellItem;

	private List<ManorExchData> dataList;
	...
	public void init(ManorBuildingData mbData)
	{
	}
