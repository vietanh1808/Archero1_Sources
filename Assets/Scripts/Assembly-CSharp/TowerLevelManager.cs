...
public class TowerLevelManager : IStageLayerManager
{
	public struct SkillWeight
	{
		...
		public SkillWeight(int id, int w)
		{
			this.id = 0;
			this.w = 0;
		}
	...
	private Tower_TowerConfigModel m_towerConfig;

	private static TowerLevelManager _instance;

	public static TowerLevelManager Instance => null;

	private void Init()
	{
	}

	public bool CheckTowerIdValid(int id)
	{
		return false;
	}

	public long GetMapStandardDefence(int id)
	{
		return 0L;
	}
	...
	public string[] GetMonsterTmxHeroUpAttributes(int id)
	{
		return null;
	}
