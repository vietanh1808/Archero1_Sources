...
public class GameModeEventTower : GameModeBase
{
	private int EventTowerId => 0;

	private Tower_EventTowerChapterDifficult EventTowerChapterDifficult => null;

	public List<string> CurrentRewardIfWinList { get; set; }
