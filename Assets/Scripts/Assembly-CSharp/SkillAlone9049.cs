...
public class SkillAlone9049 : SkillAloneBase
{
	[CompilerGenerated]
	private sealed class _003CDelayCall_003Ed__9 : IEnumerator<object>, IEnumerator, IDisposable
	{
		...
		public SkillAlone9049 _003C_003E4__this;
	...
	private float callPetRateRise;

	private int resistHitNum;

	private int invincibleBuffId;

	private int hitRiseBuffId;

	private int resistHits;

	private int addBuffTims;
