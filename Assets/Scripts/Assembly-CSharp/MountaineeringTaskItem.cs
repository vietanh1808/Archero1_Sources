...
public class MountaineeringTaskItem : UITableViewCell
{
	public ButtonCtrl btn_Go;

	public ButtonCtrl btn_Get;

	public DxxText text_Title;

	public DxxText text_Process;
	...
	private MountainTaskData itemData;

	public void Init(MountainTaskData data)
	{
	}
