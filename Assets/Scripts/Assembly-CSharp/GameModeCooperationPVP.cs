...
public class GameModeCooperationPVP : GameModeBase
{
	private IDailyLevelsManager _dailyData;

	public override IStageLayerManager StageChapterMgr => null;

	public GameModeCooperationPVP(IDailyLevelsManager dailyData)
	{
	}
	...
	public override int GetMappingSkill(int skillId)
	{
		return 0;
	}
