...
public class Act5ShopUIPanel : MediatorCtrlBase, IUIGridViewDataSource, IUITableViewDataSource, IUITableViewDelegate
{
	...
	[SerializeField]
	private Act5ShopItem cellItem;

	private List<Act5thShopItemData> dataList;
