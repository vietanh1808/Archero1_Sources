...
public class FishingGiftItemData
{
	...
	private FishingGiftItemConfigData ConfigData { get; set; }
	...
	public static FishingGiftItemData Create(FishingGiftItemConfigData configData)
	{
		return null;
	}
