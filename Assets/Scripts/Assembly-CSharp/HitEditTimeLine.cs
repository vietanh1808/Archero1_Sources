...
public class HitEditTimeLine : MonoBehaviour
{
	...
	private EntityTimeLineBase owner;
	...
	public void Init(EntityTimeLineBase pOwner)
	{
	}

	public void CopyDataFromHit(HitEdit pDes)
	{
	}
