...
public class Act4thBoxTaskUIPanel : MediatorCtrlBase, IUITableViewDataSource, IUITableViewDelegate, IUITableViewMargin
{
	...
	[HideInInspector]
	public List<Act4thBoxManager.BoxTaskData> dataList;

	public Act4thBoxTaskItemCell cellItem;
