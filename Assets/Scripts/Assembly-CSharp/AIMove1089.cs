...
public class AIMove1089 : AIMoveBase
{
	...
	private const float m_fAnglePerFrame = 0.7f;
	...
	public AIMove1089(EntityBase entity, int nReboundWallCnt, float fStartSpeed, float fMaxSpeed, Action OnColliderWallAction = null)
		: base(null)
	{
	}

	public AIMove1089(EntityBase entity)
		: base(null)
	{
	}
