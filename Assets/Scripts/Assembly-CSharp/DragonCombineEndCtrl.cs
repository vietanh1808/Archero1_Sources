...
public class DragonCombineEndCtrl : MediatorCtrlBase
{
	...
	private List<DragonCombineEndAttrCtrl> mAttList;
	...
	private LocalSave.EquipOne endTop;

	private List<LocalSave.EquipOne> basicList;
