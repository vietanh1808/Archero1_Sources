...
public class ActIslandVSShopUIPanel : MediatorCtrlBase, IUIGridViewDataSource, IUITableViewDataSource, IUITableViewDelegate
{
	...
	[SerializeField]
	private ActIslandVSShopItemCell cellItem;

	private List<ActIslandVSShopItemData> dataList;
