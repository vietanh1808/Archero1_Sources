...
public class BattlePassNewReward : MonoBehaviour
{
	[SerializeField]
	...
	private LocalSave.BattlePassNewItemData tableData;
	...
	public void SetData(LocalSave.BattlePassNewItemData data, Action onClickReward)
	{
	}
