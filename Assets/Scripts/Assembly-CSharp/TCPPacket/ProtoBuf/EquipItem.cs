...
namespace TCPPacket.ProtoBuf
{
	...
	public sealed class EquipItem : IMessage<EquipItem>, IMessage, IEquatable<EquipItem>, IDeepCloneable<EquipItem>
	{
		private static readonly MessageParser<EquipItem> _parser;
		...
		public static MessageParser<EquipItem> Parser => null;
		...
		[DebuggerNonUserCode]
		[GeneratedCode("protoc", null)]
		public EquipItem(EquipItem other)
		{
		}
