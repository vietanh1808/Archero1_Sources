...
public class TowerDefense2023LevelManager : IStageLayerManager
{
	private static TowerDefense2023LevelManager instance;

	private Stage_Level_stagechapterModel.EquipExpDropData mAct4thExchangeItems;

	public static TowerDefense2023LevelManager Instance => null;

	public void Init()
	{
	}

	private void InitAct4thExchangeItems()
	{
	}
