...
public class ArtifactAppraisaGiftItemCell : UITableViewCell
{
	...
	private ArtifactAppraisaGiftItemData itemData;

	public new void Awake()
	{
	}

	public void init(ArtifactAppraisaGiftItemData data)
	{
	}
