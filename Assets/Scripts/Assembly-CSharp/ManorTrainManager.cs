...
public class ManorTrainManager : IStageLayerManager
{
	public class ManorTrainData
	{
		private const string cfileName = "jsonData/ManorTrainData";
	...
	private static ManorTrainManager _instance;

	private ManorTrainData manorTrainData;

	public static ManorTrainManager Instance => null;
