...
namespace TableTool
{
	public class Altar_RelicsBreak : LocalBean
	{
		private ObscuredInt _BreakID;

		private ObscuredInt _LevelMax;

		private ObscuredInt _RelicsBar;

		private ObscuredInt _BloodRate;

		private ObscuredInt[] _RelicsList;
		...
		public int RelicsBar => 0;

		public int BloodRate => 0;

		public int[] RelicsList => null;
