...
namespace TableTool
{
	public class Stage_Level_stagechapter : LocalBean
	{
		...
		private ObscuredInt _ActivityItemDrop;

		private ObscuredInt _TotemDrop;

		private ObscuredInt _TotemDrop1;
		...
		private ObscuredInt _HellStagePower;

		private ObscuredInt _IsToxicfog;

		private ObscuredInt _ToxicfogRatio;

		private ObscuredString[] _Toxicfog;

		private ObscuredInt _IsVisionMist;

		private ObscuredInt _VisionMistRatio;

		private ObscuredString[] _ATKAttributesSuppress;

		private ObscuredString[] _HPMaxAttributesSuppress;

		private ObscuredString[] _ShowATKAttributesSuppress;

		private ObscuredString[] _ShowHPMaxAttributesSuppress;

		private ObscuredInt _OpenTime;

		private ObscuredInt _ErosionStep1;

		private ObscuredInt _ErosionStep2;

		private ObscuredInt _ErosionStep3;

		private ObscuredInt _ErosionStep4;

		private ObscuredInt _ErosionDisappear;

		private ObscuredString[] _ErosionReward;

		private ObscuredString[] _Transform;
		...
		public int ActivityItemDrop => 0;

		public int TotemDrop => 0;

		public int TotemDrop1 => 0;
		...
		public int HellStagePower => 0;

		public int IsToxicfog => 0;

		public int ToxicfogRatio => 0;

		public string[] Toxicfog => null;

		public int IsVisionMist => 0;

		public int VisionMistRatio => 0;

		public string[] ATKAttributesSuppress => null;

		public string[] HPMaxAttributesSuppress => null;

		public string[] ShowATKAttributesSuppress => null;

		public string[] ShowHPMaxAttributesSuppress => null;

		public int OpenTime => 0;

		public int ErosionStep1 => 0;

		public int ErosionStep2 => 0;

		public int ErosionStep3 => 0;

		public int ErosionStep4 => 0;

		public int ErosionDisappear => 0;

		public string[] ErosionReward => null;
