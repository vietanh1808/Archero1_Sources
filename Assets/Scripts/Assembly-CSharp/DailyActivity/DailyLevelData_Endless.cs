...
{
	public sealed class DailyLevelData_Endless : ILevelData
	{
		private Dictionary<int, IMissionData> m_dicMissions;

		public int LevelId { get; private set; }

		public int Count { get; private set; }

		public DailyLevelData_Endless(int levelId, int count)
		{
		}
