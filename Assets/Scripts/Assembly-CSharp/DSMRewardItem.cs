...
public class DSMRewardItem : MonoBehaviour
{
	[SerializeField]
	private Image icon;
	...
	private DeepSeaMonsterManager.DSMRewardItemData itemData;
	...
	public void Refresh(DeepSeaMonsterManager.DSMRewardItemData itemData)
	{
	}
