...
public class MiningTaskUIPanel : MediatorCtrlBase, IUITableViewDataSource, IUITableViewDelegate, IUITableViewMargin
{
	...
	[HideInInspector]
	public List<MiningTaskItemData> dataList;

	public MiningTaskItemCell cellItem;
	...
	private static DelegateBridge __Hotfix0_showTaskList;
